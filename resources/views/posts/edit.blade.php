...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <form id="postForm" method="POST" action="/posts/{{ $post[0]->id }}/edit">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="body" name="body" rows="5">{{ $post[0]->body }}</textarea>
            </div>
